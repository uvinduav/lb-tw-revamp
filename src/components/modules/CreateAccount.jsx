    ...
    <div className="page-content" style={{ backgroundColor: 'white', minHeight: 'calc(100vh - 64px)', overflowY: 'auto' }}>
      ...
      <div style={{ padding: '12px 24px 32px 24px' }}>
        ...
        <div style={{ width: '320px', flexShrink: 0 }}>
          <div style={{ backgroundColor: '#f9fafb', border: '1px solid #e5e7eb', padding: '24px', borderRadius: '8px', position: 'sticky', top: '100px' }}>
            <h2 style={{ fontSize: '16px', fontWeight: 600, color: '#111827', margin: '0 0 16px 0' }}>Summary</h2>
            
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Company</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.company || '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Bank</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.bank || '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Branch</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.branch || '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Account No.</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.accountNumber || '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Value</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.value ? `${formData.currency} ${formData.value}` : '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Start Date</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.startDate || '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Duration</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.duration || '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Repayment Freq.</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.repaymentFrequency || '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Charge Date</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.chargeDate ? `${formData.chargeDate}${formData.chargeDate === '1' ? 'st' : formData.chargeDate === '2' ? 'nd' : formData.chargeDate === '3' ? 'rd' : 'th'} day` : '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Status</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.status || '-'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid #e5e7eb' }}>
                <span style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500 }}>Interest Type</span>
                <span style={{ fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 500 }}>{formData.interestType || '-'}</span>
              </div>
            </div>
            
            <p style={{ fontSize: '12px', color: '#9ca3af', marginTop: '16px', textAlign: 'center', margin: '16px 0 0 0' }}>Fill in the form to see the summary</p>
          </div>
        </div>
      </div>
    </div>
